...
class MyProblem(ea.Problem): # 继承Problem父类
    ...
    def aimFunc(self, pop): # 目标函数
        ...
        # 生物量等参数
        VSS = VSS_data.at[("Composite_Processes","Anammox&nitrate_respiration","A&nitrate_respiration3"),"VSS"]
        #载入动力学数据
        ...
        real_data_raw = pd.read_csv("./data/A&nitrate_respiration3.csv",header=0,index_col=None,
